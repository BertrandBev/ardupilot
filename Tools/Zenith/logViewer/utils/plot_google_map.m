...
try
    ...
    try
        % Try removing key in case you aren't on KH IP address
        urlNoKey = [preamble location zoomStr sizeStr maptypeStr format markers languageStr sensor styleStr];
        urlwrite(urlNoKey,filepath);
    catch
